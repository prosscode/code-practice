package pross.code.io.multiplexingio;
...
public class MultiplexingSocketServer {
     ...
     * Java 对多路复用IO的支持
     * 重要概念
     *  1.Channel, 通道，被建立的一个应用程序和操作系统交互事件、传递内容的渠道（注意是连接到操作系统）
     *  2.Buffer, 数据缓存区。有两种工作模式：写模式(可能脏读)和读模式。
     *  3.Selector, 选择器。事件订阅和Channel管理，轮询代理，实现不同操作系统的支持
     *
     * @param args
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            while(true){
                ...
                //询问操作系统，所获取到的“所关心的事件”的事件类型（每一个通道都是独立的）
                ...
                while(selecionKeys.hasNext()) {
                    ...
                    if(readyKey.isValid() && readyKey.isAcceptable()) {
                        ...
                        /**
                         * 当server socket channel通道已经准备好，就可以从server socket channel中获取socketchannel
